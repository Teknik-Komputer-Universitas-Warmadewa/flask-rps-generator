...
def download_rps():
        ...
        for i in range(len_mingguan):
            worksheet.write(f'B{mingguan_body_start_row+i}', ((matkul_data["minggu_ke"][i])), text_cpl_format)
        ...
        def write_rpm_template(rpm_sheet_name, judul_kriteria, subcpmk_rpm, indikator_numbered_rpm, minggu_rpm, bobot_rpm):
            ...
            worksheet_rpm.merge_range("G13:J13", f'Minggu ke-{((minggu_rpm))}', text_cpl_format)
            ...
            worksheet_rpm.merge_range("B31:J31", f'Minggu ke-{((minggu_rpm))}', text_cpl_format)
